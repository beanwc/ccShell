...
static yyconst flex_int16_t yy_base[20] =
    {   0,
        0,    0,   22,   23,    0,   23,   23,   14,   12,    0,
        3,   12,   10,   23,   10,   23,    9,   10,   12
    } ;

static yyconst flex_int16_t yy_def[20] =
    {   0,
       16,    1,   16,   16,   17,   16,   16,   18,   16,   17,
       18,   19,   16,   16,   18,    0,   16,   16,   16
    } ;

static yyconst flex_int16_t yy_nxt[32] =
    {   0,
        4,    5,    6,    5,    7,    8,    4,    9,   14,   15,
       10,   10,   11,   11,   12,   12,   15,   13,   15,   13,
       12,   16,    3,   16,   16,   16,   16,   16,   16,   16,
       16
    } ;
...
static yyconst flex_int16_t yy_chk[32] =
    {   0,
       ...
       17,   17,   18,   18,   19,   19,   15,   13,   12,    9,
        8,    3,   16,   16,   16,   16,   16,   16,   16,   16,
       16
    } ;
...
char *yytext;
#line 1 "command_lex.l"
#line 2 "command_lex.l"
int _numargs = 100;
char *_args[100];
int _argcount = 0;
#line 462 "lex.yy.c"
