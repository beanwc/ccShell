...
{
       0,    26,    26,    27,    28,    29,    32,    33,    35,    36,
      37,    38,    39,    40,    41,    49,    50
};
#endif
...
/* Line 1806 of yacc.c  */
#line 36 "code_yacc.y"
    {(yyval.val) = var_memory[(yyvsp[(1) - (1)].index)];}
    break;
...
/* Line 1806 of yacc.c  */
#line 37 "code_yacc.y"
    {(yyval.val) = var_memory[(yyvsp[(1) - (3)].index)] = (yyvsp[(3) - (3)].val);}
    break;
